...
public class ROVStateX
{
    ...
    public void sendCommand(final String s, final int n) {
        ...
        int n3 = 0;
            ...
            if (s.equals(ROVStateX.front) || s.equals(ROVStateX.back) || s.equals(ROVStateX.left) || s.equals(ROVStateX.right)|| s.equals(ROVStateX.move4)|| s.equals(ROVStateX.move1)|| s.equals(ROVStateX.move2)|| s.equals(ROVStateX.move3)) {
                ...
                Log.e("PPPPP",s.equals(ROVStateX.front)+":"+s+":"+ROVStateX.move1);
               // Log.e("TTTTT","creating command "+s);
                array = this.createMotionCommand(s, n, this.id);
                n2 = this.id;
                ++this.id;
                n3 = 6;
        }
        else if(s.equals(ROVStateX.nitro))
        {
            Log.w("TTTTT","creating command 1 "+s);
            array = this.createMotionCommand(s, n, this.id);
            n2 = this.id;
            ++this.id;
            n3 = 6;
            ...
            //Log.w("TTTTT","creating command 2 "+s);
    ...
    public void sendUpdates() {
        ...
        this.sendCommand(ROVStateX.ping, -1);
    }
    ...
    public String name;
    public void startCommunication(final MainActivity activity,String _name) throws UnknownHostException, IOException {
        ...
        this.mProgressChecker = new Runnable() {
            ...
            public void run() {
                ...
                if (ROVStateX.this.mHandler != null) {
                    ROVStateX.this.mHandler.postDelayed(ROVStateX.this.mProgressChecker,500L);
                }
            }
        };
