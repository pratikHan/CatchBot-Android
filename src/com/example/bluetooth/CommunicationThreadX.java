...
public class CommunicationThreadX extends Thread
{
    ...
    public void addWork(final String s, final byte[] array, final int n, final int n2) {
        ...
        try {
            ...
            if (s.equals(ROVStateX.front) || s.equals(ROVStateX.back) || s.equals(ROVStateX.left) || s.equals(ROVStateX.right) || s.equals(ROVStateX.nitro) || s.equals(ROVStateX.move4) || s.equals(ROVStateX.move3) || s.equals(ROVStateX.move2) || s.equals(ROVStateX.move1)) {
            	//array -length - id            	
